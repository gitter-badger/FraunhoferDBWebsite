...
//sql for table data
$sql = "SELECT l.line_on_po, l.quantity, l.tool_ID, IF(l.diameter = '' or l.diameter = 0, 'N/A', l.diameter), IF(l.length = '' or l.length = 0, 'N/A', l.length), IF(l.double_end = 1, 'Yes', 'No'), l.price, ROUND(l.price * l.quantity, 2) 
        FROM lineitem l, POS p   
        WHERE l.po_ID = '$po_ID'
